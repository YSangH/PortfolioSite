        ...
        >
          <Contents
            ...
            contents={[
              ...
              웹개발자 실무 양성과정 교육을 받으면서, 팀원들과 GitHub를 이용하여 
...
일용직에서도 소통이 잘 안되면 업무배정에 혼란이 생기는 것을 알기에 중요시합니다. 

두 번째는 대처능력입니다.
웹개발자 실무 양성과정 교육에서 프로젝트에 참여와 아르바이트, 일용직을 했을 당시에 
여러 상황에 직면해야 했고, 그 때마다 신속한 판단력과 유연한 대처가 요구되었습니다.
그런 상황이 닥칠 때 여러가지의 방안을 생각해보고 가장 최선인 방향으로 해결하려는 자세를 지니게 되었습니다.
