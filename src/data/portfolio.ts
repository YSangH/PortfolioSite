...
export const portfolioProjects: Project[] = [
  {
    ...
    name: "비즈니스 플랫폼",
    description: "자바기반 풀스택 웹 개발자 실무 양성과정 4인 SemiProject입니다.",
  ...
  },
  {
    ...
    name: "숙박업소 플랫폼",
    description: "자바기반 풀스택 웹 개발자 실무 양성과정 4인 FinalProject입니다.",
  ...
  },
  {
    ...
    description: "React와 ZegoCloud, Firebase를 이용한 Zoom 화상채팅 클론코딩입니다.",
  ...
  },
  {
    ...
    name: "개발자 포트폴리오 홈페이지",
    description: "Next.js와 materialUI를 이용하여 제작한 개발자 홈페이지 입니다.",
